  ...
  progressoFollowUps: router({
    ...
    getProgresso: corretorProcedure
      .query(async ({ ctx }) => {
        ...
        // ⚠️ SISTEMA TEMPORARIAMENTE DESBLOQUEADO ⚠️
        // O bloqueio de follow-ups está DESATIVADO até segunda ordem
        // Todos os corretores podem trabalhar livremente
        console.log('[Desbloqueio] Sistema PERMANENTEMENTE desbloqueado - bloqueio desativado');
        ...
        return {
          ...
          concluidos,
          percentual,
          desbloqueado: true, // ✅ SEMPRE DESBLOQUEADO
        };
      }),
  }),
