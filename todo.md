...
## Nova Feature: Limite Diário de Leads por Corretor
- [ ] Adicionar campo limiteDiarioLeads no schema de corretores (padrão: null = sem limite)
- [ ] Executar migração do banco de dados
- [ ] Criar função para contar leads distribuídos hoje para um corretor
- [ ] Atualizar lógica de distribuição automática para respeitar limite diário
- [ ] Adicionar campo de configuração de limite na página de perfil do corretor
- [ ] Adicionar campo de configuração de limite na gestão de corretores (gestor)
- [ ] Criar indicador visual mostrando "X/Y leads recebidos hoje"
- [ ] Testar distribuição automática com limites configurados
