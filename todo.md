...
## Nova Feature: Mapa Interativo de Projetos
- [x] Criar componente ProjetosMapView com Google Maps
- [x] Adicionar pins/markers para cada projeto no mapa
- [x] Implementar InfoWindow com resumo do projeto ao hover
- [x] Implementar navegação para página de detalhes ao clicar no pin
- [x] Adicionar sistema de abas (Lista/Mapa) na página de Projetos
- [x] Aplicar filtros existentes (zona, status, construtora) no mapa
- [x] PROBLEMA RESOLVIDO: Limitar a 20 projetos com endereço completo
- [x] Testar funcionalidade completa - FUNCIONANDO!
