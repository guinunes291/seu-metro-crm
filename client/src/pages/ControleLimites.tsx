        ...
        <Card>
          ...
          <CardContent className="space-y-3 text-sm text-muted-foreground">
            <div className="flex items-start gap-2">
              ...
              <div>
                <strong className="text-foreground">Distribuição Automática:</strong> Limite para leads da base que são redistribuídos automaticamente. Corretores com 60% dos leads trabalhados e status "Presente" recebem leads até atingir este limite.
              </div>
            </div>
            <div className="flex items-start gap-2">
